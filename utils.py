...
def get_args_parser():
    ...
    parser.add_argument('--data-path', default='', type=str,
                        help='dataset path')
    parser.add_argument('--data-set', default='Food101', choices=['CIFAR', 'IMNET', 'INAT', 'INAT19', 'Food101'],
    ...
    parser.set_defaults(compile_model=False)  # Default is to use torch.compile
...
def visualize_batch(images, labels, args):
    # Denormalize images if necessary
    # Assuming IMAGENET_DEFAULT_MEAN and IMAGENET_DEFAULT_STD are used
